        ...
        <div className="container mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
            ...
            <Card className="bg-background border-border hover:border-gold transition-all duration-300 group overflow-hidden">
              <div className="relative h-48 overflow-hidden">
                <img 
                  src="https://cdn.poehali.dev/files/d59f3141-c622-4622-a2a7-e2e6ce77cac9.jpg" 
                  alt="Мойка двигателя паром"
                  className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-300"
                />
              </div>
              <CardContent className="p-6">
      ...
      <section id="gallery" className="py-20 px-4 bg-card">
        <div className="container mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-7xl mx-auto">
            ...
            <div className="group relative overflow-hidden rounded-lg aspect-square">
              <img 
                src="https://cdn.poehali.dev/files/625ee2d3-37dd-4b3f-bac9-8a33a36e5349.jpg" 
                alt="Контурная подсветка салона"
                className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-300"
              />
            </div>
            ...
            <div className="group relative overflow-hidden rounded-lg aspect-square">
              <img 
                src="https://cdn.poehali.dev/files/65e71d69-7f69-4561-af83-0f84f19e721d.jpg" 
                alt="Чистый двигатель после мойки паром"
                className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-300"
              />
            </div>
            <div className="group relative overflow-hidden rounded-lg aspect-square">
